        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <ul class="navbar-nav mr-auto">
                    @guest
                    <li class="nav-item"><a href="{{ route('login') }}" class="nav-link ml-5"><span class="log-link">@lang('Login')</span></a></li>
                    @request ('register')
                    <li class="nav-item"><a href="{{ request()->url() }}" class="nav-link ml-5"><span class="log-link">@lang('Register')</span></a></li>
                    @endrequest
                    ...
                    <div class="dropdown ml-4">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="{{ route('logout') }}" class="dropdown-item" onclick="event.preventDefault(); this.previousElementSibling.submit();"><span>@lang('Logout')</span></a>
                            </li>
                        </div>
                    </div>
                    @endguest
